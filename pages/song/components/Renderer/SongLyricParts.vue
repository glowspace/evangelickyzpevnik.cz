  ...
  <div v-if="song_lyric_parts">
    ...
    >
      <div
        ...
        :key="key2"
        :class="[
          { 'song-line--newline': isLineNewLine(line) },
          'song-line',
      ...
      >
        ...
        <span>&#8201;</span>
        <span v-if="!key2" class="song-part-tag"
          >{{
            part.type + (part.type ? (part.isVerse ? '.' : ':') : '')
          }}&nbsp;</span
        ><template v-for="(chord, key3) in line.chords" :key="key3">
          <chord
            :base="chord.base"
  ...
  methods: {
    ...
    isLineNewLine(line) {
      return (
        ...
        line.chords[0].base + line.chords[0].text == ''
      );
    },
  },
